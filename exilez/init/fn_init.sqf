...
ZMarkerAlpha			= 0.15;			// Alpha *(Transparency)of the zone
...
HZGroupsSize			= 10;			// maximum number of zombies around a player
HZFrequency				= 60;			// time in seconds between each new zombie.
HZMaxDistance			= 400;			// maximum distance from the player before the zombie is deleted.
HZMaxSpawnDistance		= 300;			// maximum spawn distance from the player.
HZMinSpawnDistance		= 100;			// minimum spawn distance from the player. (don't set 0)
