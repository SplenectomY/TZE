...
private["_display","_hunger","_hungerValueControl","_hungerLabelControl","_thirst","_thirstValueControl","_thirstLabelControl","_health","_healthValueControl","_healthLabelControl"];
